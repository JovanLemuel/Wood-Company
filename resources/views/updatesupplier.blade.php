...
@section('content')
    <div class="text-center pt-20 py-12 px-6 mt-12">
        <h1 class="font-display font-bold text-5xl mb-6">Update Supplier</h1>
    </div>
    <div class="container mx-auto px-6 mb-24">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <form action="{{ route('suppliers.update', $supplier->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="" class="block text-base tracking-tight text-gray-600">Phone</label>
                    <input type="text" name="phone"
                        class="mt-2 w-full border-none text-sm p-4 bg-gray-100 text-gray-700"
                        value="{{ $supplier->phone }}">
                </div>
                <div class="mb-3">
                    <label for="" class="block text-base tracking-tight text-gray-600">City</label>
